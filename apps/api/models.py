...
class User(Base):
    ...
    email = Column(String, unique=True, nullable=False, index=True) # Required
...
class SourceChunk(Base):
    ...
    program_id    = Column(Integer, ForeignKey("programs.id"), nullable=False, index=True)
    section_label = Column(String, nullable=False, index=True)
    ...
    program = relationship("Program", back_populates="chunks")
